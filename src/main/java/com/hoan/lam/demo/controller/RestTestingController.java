...
//	}
	...
	@PostMapping(value = "search", consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE)
	public ResponseEntity<MFWResponse> search(final MultiReadRequestWrapper request) throws IOException {
		log.info("{}", request.getBody());
		MFWResponse resp = new MFWResponse(MFWOrderStatusEnum.MFW1000);
